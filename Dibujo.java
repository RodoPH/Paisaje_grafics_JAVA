...
//Montaña
           ...
           g.fillOval(150,190,80,100);
           for (int i = 40
                   ; i < 300; i++) {
            g.drawLine(i,350,200, 200);
        }
           for (int i = 0; i < 10; i++) {
...
//Flores
        ...
        g.fillRect(215, 390, 2, 10);
        g.setColor(new Color(233, 78, 0));
        g.fillOval(212, 385, 6, 6);
        g.setColor(Color.white);
        g.fillOval(212, 385, 6, 6);
        g.setColor(new Color(173, 79, 178));
        g.fillOval(211, 379, 8, 8);
        g.fillOval(216, 385, 8, 8);
        g.fillOval(205, 385, 8, 8);
        //
        g.setColor(new Color(102, 0, 0));
        g.fillRect(230, 390, 2, 10);
        g.setColor(new Color(233, 78, 0));
        g.fillOval(228, 385, 6, 6);
        g.setColor(Color.white);
        g.fillOval(228, 385, 6, 6);
        g.setColor(new Color(173, 79, 178));
        g.fillOval(227, 379, 8, 8);
        g.fillOval(232, 385, 8, 8);
        g.fillOval(221, 385, 8, 8);
        //
        g.setColor(new Color(102, 0, 0));
        g.fillRect(245, 390, 2, 10);
        g.setColor(new Color(233, 78, 0));
        g.fillOval(243, 385, 6, 6);
        g.setColor(Color.white);
        g.fillOval(243, 385, 6, 6);
        g.setColor(new Color(173, 79, 178));
        g.fillOval(242, 379, 8, 8);
        g.fillOval(247, 385, 8, 8);
        g.fillOval(236, 385, 8, 8);
        //
        g.setColor(new Color(102, 0, 0));
        g.fillRect(260, 390, 2, 10);
        g.setColor(new Color(233, 78, 0));
        g.fillOval(258, 385, 6, 6);
        g.setColor(Color.white);
        g.fillOval(258, 385, 6, 6);
        g.setColor(new Color(173, 79, 178));
        g.fillOval(257, 379, 8, 8);
        g.fillOval(262, 385, 8, 8);
        g.fillOval(251, 385, 8, 8);
        // 
        g.setColor(new Color(102, 0, 0));
        g.fillRect(275, 390, 2, 10);
        g.setColor(new Color(233, 78, 0));
        g.fillOval(273, 385, 6, 6);
        g.setColor(Color.white);
        g.fillOval(273, 385, 6, 6);
        g.setColor(new Color(173, 79, 178));
        g.fillOval(272, 379, 8, 8);
        g.fillOval(277, 385, 8, 8);
        g.fillOval(264, 385, 8, 8);
//Ovni
        g.setColor(Color.BLACK);
